...
# Cached construction of constant tensors (avoids repeated CPU=>GPU copy).
...
# Assert that the shape of a tensor matches the given list of integers (None = any size).
...
# Sampler that loops over the dataset indefinitely, shuffling items as it goes.
