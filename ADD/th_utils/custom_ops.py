...
def get_plugin(module_name, sources, headers=None, source_dir=None, **build_kwargs):
    ...
    try: # pylint: disable=too-many-nested-blocks
        ...
        # Unset TORCH_CUDA_ARCH_LIST to let nvcc decide based on the machine.
        os.environ['TORCH_CUDA_ARCH_LIST'] = ''

        # Incremental build: cache copied sources under a combined md5 digest for fast rebuilds.
