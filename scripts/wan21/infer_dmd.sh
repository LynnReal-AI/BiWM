#!/usr/bin/bash
# =============================================================================
# Wan 2.1 1.3B - Inference: chunk-by-chunk 4-step autoregressive rollout (Stage 2 DMD generator)
# =============================================================================
...
# All values below are env-overridable, e.g.:  GENERATOR_CKPT=... ACTION_FRAMES="w-8, a-11" bash scripts/wan21/infer_dmd.sh
# =============================================================================
set -e
...
SEED=${SEED:-42}
OUTPUT=${OUTPUT:-./outputs/wan21_dmd_infer.mp4}
