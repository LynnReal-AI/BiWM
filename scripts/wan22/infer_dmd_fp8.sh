#!/usr/bin/bash
# =============================================================================
# Wan 2.2 TI2V-5B - FP8-E4M3 quantized DMD inference (thin wrapper over infer_dmd.sh)
# =============================================================================
...
#   Use the QAT generator weights from scripts/wan22/stage3_fp8_optional.sh.
#   All infer_dmd.sh env vars apply (GENERATOR_CKPT / PROMPT / MODE / ACTION_FRAMES / ...).
# Example:  GENERATOR_CKPT=... FP8_KERNEL=1 bash scripts/wan22/infer_dmd_fp8.sh
# =============================================================================
set -e
...
export OUTPUT="${OUTPUT:-./outputs/wan22_dmd_infer_fp8.mp4}"
