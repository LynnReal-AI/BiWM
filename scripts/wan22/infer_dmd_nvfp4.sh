#!/usr/bin/bash
# =============================================================================
# Wan 2.2 TI2V-5B - NVFP4 quantized DMD inference (thin wrapper over infer_dmd.sh)
# =============================================================================
...
#   Use the QAT generator weights from scripts/wan22/stage3_nvfp4_optional.sh.
#   All infer_dmd.sh env vars apply (GENERATOR_CKPT / PROMPT / MODE / ACTION_FRAMES / ...).
# Example:  GENERATOR_CKPT=... NVFP4_KERNEL=gen_nvfp4.safetensors bash scripts/wan22/infer_dmd_nvfp4.sh
# =============================================================================
set -e
...
export OUTPUT="${OUTPUT:-./outputs/wan22_dmd_infer_nvfp4.mp4}"
