...
# MIT License, Copyright (c) Authors of "PRoPE: Projective Positional Encoding for Multiview Transformers"
...
def prope_qkv(
    ...
    **kwargs,
    ...
    """Apply PRoPE-style positional encoding to q/k/v (seqlen == cameras * patches_x * patches_y)."""
