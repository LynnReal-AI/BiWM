...
class PatchEmbed(nn.Module):
    """Image to Patch Embedding using Conv2d. Based on google-research/vision_transformer."""
...
class TextProjection(nn.Module):
    """Projects text embeddings. Adapted from PixArt-alpha PixArt_blocks.py."""
...
def timestep_embedding(t, dim, max_period=10000):
    """Create sinusoidal timestep embeddings. Ref: openai/glide-text2im glide_text2im/nn.py."""
    half = dim // 2
    freqs = torch.exp(
        -math.log(max_period)
