...
# Wan2.2 official negative prompt (for CFG)
...
# ===== LoRA (manual minimal implementation; avoids the PEFT 0.19 + torch 2.5.1 incompatibility) =====
# Used by Stage 1 (parameter-efficient fine-tuning) and Stage 2 (DMD).
...
# =============================================================================
# Intra-node shared text encoding (all_gather + leader does the encoding + each rank fetches its own result)
# =============================================================================
