...
def merge_video_audio(video_path: str, audio_path: str):
    """Merge video and audio (duration = shorter of the two) and overwrite the original video."""
    # set logging
...
def str2bool(v):
    """Convert a string to a boolean (true: yes/true/t/y/1, false: no/false/f/n/0)."""
